            ...
            <ul className={menuStyles.optionsGrid}>
              ...
              <li className={menuStyles.orderOption}>
                <div>
                  ...
                  <p className={menuStyles.optionDescription}>
                    Massa de macarrão da casa, molho de aveia, espinafre,
                    cebola, cebolinha, manjericão, tomate cereja
                  </p>
                </div>
                <div className={menuStyles.priceRow}>
              ...
              <li className={menuStyles.orderOption}>
                <div>
                  ...
                  <p className={menuStyles.optionDescription}>
                    ...
                    cheddar vegano de castanha de caju, cebola refogada,
                    pimentão, alface e tomate
                  </p>
                </div>
                <div className={menuStyles.priceRow}>
            ...
            <ul className={menuStyles.optionsGrid}>
              ...
              <li className={menuStyles.orderOption}>
                <div>
                  ...
                  <p className={menuStyles.optionDescription}>
                    Porção de biscoitos feitos com banana, aveia, castanha do
                    pará e uvas passas
                  </p>
                </div>
                <div className={menuStyles.priceRow}>
            ...
            <ul className={menuStyles.optionsGrid}>
              ...
              <li className={menuStyles.orderOption}>
                <div>
                  ...
                  <p className={menuStyles.optionDescription}>
                    Leite de coco, morango, amora, mirtilo, romã, beterraba e
                    chia
                  </p>
                </div>
                <div className={menuStyles.priceRow}>
              ...
              <li className={menuStyles.orderOption}>
                <div>
                  ...
                  <p className={menuStyles.optionDescription}>
                    Leite vegetal de castanha, gengibre, polpa de maracujá,
                    polpa de açaí, banana, beterraba, mirtilo, amora, pistache
                  </p>
                </div>
                <div className={menuStyles.priceRow}>
